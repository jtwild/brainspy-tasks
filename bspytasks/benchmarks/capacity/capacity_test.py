...
class CapacityTest():
    ...
    def __init__(self, configs):
        ...
        self.vcdimension_test = VCDimensionTest(configs['vcdim_configs'])
    ...
    def run_test(self):
        ...
        while True:
            ...
            if not results[str(self.current_dimension)] or not self.next_vcdimension():
                ...
                save(mode='configs', path=self.configs['vcdim_configs']['output_dir'], filename='test_configs.json', data=self.configs)
                save(mode='configs', path=self.configs['vcdim_configs']['output_dir'], filename='algorithm_configs.json', data=self.vcdimension_test.algorithm.config_dict)
...
if __name__ == '__main__':
    ...
    capacity_test_configs = load_configs('configs/benchmark_tests/capacity_test/capacity_test_template.json')
