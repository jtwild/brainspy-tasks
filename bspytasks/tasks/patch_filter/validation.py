...
class PatchFilterValidator():
    ...
    def init_processors(self):
        ...
        #self.processor = get_processor(self.configs['algorithm_configs']['processor']) #only validation for now
    ...
    def get_hardware_output(self,results, model):
    ...
    def validate(self, results, model):
        ...
        real_output, mask = self.get_hardware_output(results, model)
